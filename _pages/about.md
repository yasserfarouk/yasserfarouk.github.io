...
<div class="col-sm-8 col-xs-12">
  ...
  {% if member.academic %} <a href="{{ member.academic }}" target="_blank"><i class="ai ai-academia-square fa-3x"></i></a> {% endif %}
  {% if member.publons %} <a href="{{ member.publons }}" target="_blank"><i class="ai ai-publons-square fa-3x"></i></a> {% endif %}
...
{% if site.data.recognitions %}
<div class="jumbotron">
### Recognition
<ul>
{% for rec in site.data.recognitions %}
 <li> {{ rec.name }} </li>
{% endfor %}
</ul>
</div>
